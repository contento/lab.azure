...
- The checked-in `app/staticwebapp.config.json` intentionally contains `__TENANT_ID__`. `deploy-code.ps1` substitutes it only while publishing and restores the template afterward.
